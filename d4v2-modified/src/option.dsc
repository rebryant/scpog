...
("weak-weight", boost::program_options::value<double>()->default_value(1.0), "Weight given to weak (projection) variables in variable selection")
("skolemize", boost::program_options::value<bool>()->default_value(false), "Generate Skolem assignments.")
("quiet", boost::program_options::value<bool>()->default_value(false), "Reduce amount of information printed.")